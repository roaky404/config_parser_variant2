...
- Числа, строки (в формате `@"строка"`)
- Массивы: `array(значение, значение, ...)`
- Словари: `begin имя := значение; ... end`
- Многострочные комментарии: `#| ... |#`
- Однострочные комментарии: `# ...`
- Константы времени компиляции: `имя <- значение;`
- Константные выражения: `${+ a b}`, `${* x y}`, `${len значение}`
- Вложенные структуры
...
1. **Лексический и синтаксический анализ:** выполняется библиотекой Lark по заданной грамматике
2. **Трансформация:** преобразование дерева разбора в Python-объекты
3. **Сериализация:** конвертация Python-объектов в JSON
